...
This document describes the schema for the [Windows-specific section](config_zh.md#platform-specific-configuration) of the [container configuration](config_zh.md).
